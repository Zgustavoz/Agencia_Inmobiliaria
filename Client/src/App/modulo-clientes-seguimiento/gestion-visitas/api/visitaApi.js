...
export const getVisitas = async (params = {}) => {
  const { data } = await intanciaAxios.get("/api/clientes/visitas/", { params });
  return data;
};
...
export const updateVisita = async (id, data) => {
  const response = await intanciaAxios.patch(`/api/clientes/visitas/${id}/`, data);
  return response.data;
};

export const getHorariosDisponibilidad = async (params = {}) => {
  const { data } = await intanciaAxios.get("/api/clientes/horarios-disponibilidad/", { params });
  return data;
};

export const createHorarioDisponibilidad = async (data) => {
  const res = await intanciaAxios.post("/api/clientes/horarios-disponibilidad/", data);
  return res.data;
};
