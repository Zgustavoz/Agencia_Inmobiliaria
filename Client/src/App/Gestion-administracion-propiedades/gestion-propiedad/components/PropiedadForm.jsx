...
export const PropiedadForm = ({ onCancel, onSuccess, propiedadAEditar }) => {
  ...
  useEffect(() => {
    if (propiedadAEditar) {
      setFormData({
        ...
        superficie_construida_m2:
          propiedadAEditar.superficie_construida_m2 || "",
        ...
        caracteristicas_adicionales:
          propiedadAEditar.caracteristicas_adicionales || "",
  ...
  const handleSave = async () => {
    ...
    data.append(
      "superficie_construida_m2",
      formData.superficie_construida_m2 || 0,
    );
    ...
    data.append(
      "caracteristicas_adicionales",
      formData.caracteristicas_adicionales,
    );
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-neutral-400">
            Edita o registra la propiedad
          </p>
        </div>
        <div className="flex gap-4">
          <button
            onClick={onCancel}
            className="px-6 py-2 text-sm font-semibold text-neutral-500 hover:text-neutral-700"
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="bg-[#0052CC] text-white px-8 py-2.5 rounded-lg font-bold text-sm shadow-lg hover:bg-[#0041a3] transition-all"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
            <h3 className="text-[#0052CC] text-[10px] font-black uppercase tracking-widest mb-6">
              Informacion Basica
            </h3>
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-neutral-50 border-none rounded-xl text-sm focus:ring-2 focus:ring-blue-100 outline-none"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-neutral-50 rounded-xl text-sm font-bold border-none outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full p-3 bg-neutral-50 border-none rounded-xl text-sm outline-none"
                  >
                ...
                <div>
                  ...
                  <select
                    name="modalidad_operacion"
                    value={formData.modalidad_operacion}
                    onChange={handleChange}
                    className="w-full p-3 bg-neutral-50 border-none rounded-xl text-sm outline-none"
                  >
                    <option value="Para Alquiler">Para Alquilar</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-4 bg-neutral-50 border-none rounded-xl text-sm h-32 outline-none"
                  placeholder="A masterpiece of modern architecture..."
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-neutral-50 p-4 rounded-xl text-center">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="bg-transparent text-center font-bold text-neutral-800 outline-none w-full"
                  defaultValue={0}
                />
              </div>
              <div className="bg-neutral-50 p-4 rounded-xl text-center">
              ...
              <div className="bg-neutral-50 p-4 rounded-xl text-center">
                ...
                <input
                  name="superficie_construida_m2"
                  type="number"
                  value={formData.superficie_construida_m2}
                  onChange={handleChange}
                  className="bg-transparent text-center font-bold text-neutral-800 outline-none w-full"
                  placeholder="7000"
                />
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div>
                <label className="text-[10px] font-bold text-neutral-400 uppercase block mb-2">
                  Garajes
                </label>
                <input
                  name="garajes"
                  ...
                  onChange={handleChange}
                  className="w-full p-3 bg-neutral-50 border-none rounded-xl text-sm font-bold outline-none"
                />
              </div>
              <div>
                <label className="text-[10px] font-bold text-neutral-400 uppercase block mb-2">
              ...
              <div>
                ...
                <input
                  ...
                  type="number"
                  value={formData.antiguedad_anios}
                  onChange={handleChange}
                  className="w-full p-3 bg-neutral-50 border-none rounded-xl text-sm font-bold outline-none"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <textarea
                  ...
                  value={formData.servicios_basicos}
                  onChange={handleChange}
                  className="w-full p-3 bg-neutral-50 border-none rounded-xl text-xs outline-none h-20"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center">
                ...
                />
                <label className="text-[10px] font-bold text-neutral-400 uppercase ml-2">
                  Amoblado
                </label>
              </div>
              <div className="flex items-center">
                <input
                  name="publicado_movil"
                  type="checkbox"
                  checked={formData.publicado_movil}
                  onChange={handleChange}
                  className="w-4 h-4 rounded cursor-pointer"
                />
                <label className="text-[10px] font-bold text-neutral-400 uppercase ml-2">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-[#0052CC] text-[10px] font-black uppercase tracking-widest">
                Ubicación Exacta
              </h3>
            ...
            <div className="h-[400px] rounded-2xl overflow-hidden border border-neutral-100 relative">
              <MapContainer
                ...
                center={
                  formData.longitud && formData.latitud
                    ? [formData.longitud, formData.latitud]
                    : undefined
                }
        ...
        <div className="space-y-6">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100">
            ...
            {previews.length > 0 && (
              <div className="mb-4">
                <p className="text-[10px] font-bold text-neutral-400 uppercase mb-2">
                  Nuevas Imágenes
                </p>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {existingImages.map((img, i) => (
                    <div
                      key={img.id_imagen || i}
                      className="aspect-square rounded-lg overflow-hidden border border-neutral-100"
                    >
                      <img
                        src={img.url_imagen}
                        alt={`actual ${i}`}
                  ...
                  {zonas.length > 0 ? (
                    zonas.map((z) => (
                      <option key={z.id_zona} value={z.id_zona}>
                        {z.nombre || z.zona}{" "}
                        {/* Intentamos leer 'nombre' o 'zona' según tu Serializer */}
                      </option>
                    ))
                  ) : (
